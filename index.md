...
<style>
  body {
    background-color: #0b0c10; /* Hacker theme dark background */
    color: #66fcf1; /* Bright cyan for text */
    font-family: 'Courier New', Courier, monospace; /* Classic hacker font */
    text-align: center; /* Center align all text */
  }

  h1 {
    color: #45a29e; /* Cyan green for main heading */
  }

  h2 {
    color: #66fcf1; /* Bright cyan for subheadings */
  }

  p, li {
    color: #c5c6c7; /* Light gray for body text */
  }

  a {
    color: #66fcf1; /* Bright cyan for links */
    text-decoration: none; /* Remove underline */
  }

  a:hover {
    color: #45a29e; /* Cyan green for hover links */
